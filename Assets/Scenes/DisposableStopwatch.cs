...
public class DisposableStopwatch : IDisposable
{
    ...
    public DisposableStopwatch(string textWithPlaceholders, LogType logEventLevel = LogType.Log)
    ...
    private static void LogTextWithPlaceholders(Stopwatch sw, string textWithPlaceholders, LogType logEventLevel)
    {
        ...
        Debug.LogFormat(logEventLevel, LogOption.None, null, logText);
    }
